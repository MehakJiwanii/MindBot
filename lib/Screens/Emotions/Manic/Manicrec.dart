...
class Manicrec extends StatefulWidget {
  const Manicrec({super.key});

  @override
  State<Manicrec> createState() => _ManicrecState();
}

class _ManicrecState extends State<Manicrec> {
  @override
            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: [
                  Center(
                    child: Text(
                        '"In the whirlwind of chaos, the manic\n mind dances to its own unpredictable\n rhythm, seeking solace in the storm\n of thoughts."',
                        style: GoogleFonts.epilogue(
                          fontSize: 15,
