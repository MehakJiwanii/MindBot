...
class Anxietybot extends StatefulWidget {
  const Anxietybot({super.key});

  @override
  State<Anxietybot> createState() => _AnxietybotState();
}

class _AnxietybotState extends State<Anxietybot> {
  @override
                    ...
                    return GestureDetector(
                        onTap: () async {
                          final Uri url = Uri.parse(
                              'https://www.helpguide.org/articles/anxiety/i-feel-anxious-tips-for-dealing-with-anxiety.htm');
